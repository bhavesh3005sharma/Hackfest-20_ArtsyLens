package com.example.artstlens.Fragments.CycleganFragment;
...
public class CycleganFragment extends Fragment implements Contract.mainView ,AdapterRV.OnItemClickListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view  =  inflater.inflate(R.layout.cyclegan_fragment,container,false);
        ButterKnife.bind(this,view);
        getActivity().setTitle("Cyclegan Pics Collection");
        presenter = new Presenter(CycleganFragment.this);
    ...
    public void setRecyclerView(ArrayList<Upload> list) {
        ...
        adapterRV.setOnItemClickListener(CycleganFragment.this);
    }
