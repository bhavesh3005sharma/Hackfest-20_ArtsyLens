...
public class Paint extends View {
    ...
    private android.graphics.Paint drawPaint,canvasPaint;
    private Canvas drawCanvas;
    private int paintColor = 0xff;
    private Bitmap canvasBitmap;
    private float brushSize,lastBrush;
    private Path drawPath;


    public Paint(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        setupDrawing();
    }
    ...
    public void setLastBrush(float lastSize){
        lastBrush =lastSize;
    }
    ...
    public void setupDrawing(){
        ...
        canvasPaint = new android.graphics.Paint(android.graphics.Paint.DITHER_FLAG);
        brushSize = 10;
        lastBrush = brushSize;
        drawPaint.setStrokeWidth(brushSize);
    }
